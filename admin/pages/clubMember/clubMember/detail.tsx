...
import { BooleanCell, DataGrid, DetailScope, DisplayTextField, GenericCell, HasOneSelectCell, Link, LinkButton, NavigateBackLink, Stack } from '@contember/admin'
...
export default () => <>
	...
	<DetailScope entity="ClubMember(id=$id)">
		...
		<Slots.Actions>
			...
			<LinkButton to="clubMember/clubMember/registration(id: $entity.id)">
				Registration
			</LinkButton>
		</Slots.Actions>
		<Slots.ContentStack>
